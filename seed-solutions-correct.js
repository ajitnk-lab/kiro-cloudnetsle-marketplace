...
// This is the table the catalog function is actually using
const SOLUTION_TABLE_NAME = 'marketplace-solutions-1765298234511';
...
async function seedSolutions() {
  console.log('Seeding solutions to CORRECT table:', SOLUTION_TABLE_NAME);
